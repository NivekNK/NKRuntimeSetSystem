...
namespace NK.RuntimeSetSystem
{
    ...
    {
        /// <summary>
        /// Return the first encountered RuntimeSet of the specified type in "Resources/RuntimeSets" folder or null if none is find.
        /// </summary>
    ...
    public abstract class NKRuntimeSet<T> : NKRuntimeSet
    {
